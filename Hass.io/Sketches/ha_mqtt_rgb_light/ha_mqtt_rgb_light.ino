...
const PROGMEM char* MQTT_CLIENT_ID = "tv_rgb_light";
const PROGMEM char* MQTT_SERVER_IP = "192.168.188.24";
const PROGMEM uint16_t MQTT_SERVER_PORT = 1883;
const PROGMEM char* MQTT_USER = "homeassistant";
const PROGMEM char* MQTT_PASSWORD = ""; // REMOVED

// MQTT: topics
// state
const PROGMEM char* MQTT_LIGHT_STATE_TOPIC = "tv/rgb1/light/status";
const PROGMEM char* MQTT_LIGHT_COMMAND_TOPIC = "tv/rgb1/light/switch";

// brightness
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC = "tv/rgb1/brightness/status";
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC = "tv/rgb1/brightness/set";

// colors (rgb)
const PROGMEM char* MQTT_LIGHT_RGB_STATE_TOPIC = "tv/rgb1/rgb/status";
const PROGMEM char* MQTT_LIGHT_RGB_COMMAND_TOPIC = "tv/rgb1/rgb/set";
